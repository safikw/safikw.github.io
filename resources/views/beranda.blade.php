    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-6 col-lg-4">
          ...
          <p class="mb-5">lapskuy! adalah web application yang berguna untuk memantau dan melap
          orkan kerusakan – kerusakan yang terjadi di daerah pariwisata yang khususnya di Yogyakarta.</p>
        </div>
